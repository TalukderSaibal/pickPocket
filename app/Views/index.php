...
<head>
    ...
    <title>Everything is here | PickPocket</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="pull-left m-r-10 avatar-img"
                                                        src="<?= base_url('images/avatar/3.jpg') ?>" alt="" />
                                    ...
                                    <div class="dropdown-content-body">
                                        <ul>
                                            <li class="notification-unread">
                                                <a href="#">
                                                    <img class="pull-left m-r-10 avatar-img"
                                                        src="<?= base_url('images/avatar/1.jpg') ?>" alt="" />
                                                    <div class="notification-content">
                                                        <small class="notification-timestamp pull-right">02:34
                                                            PM</small>
                                            ...
                                            <li class="notification-unread">
                                                <a href="#">
                                                    <img class="pull-left m-r-10 avatar-img"
                                                        src="<?= base_url('images/avatar/2.jpg') ?>" alt="" />
                                                    <div class="notification-content">
                                                        <small class="notification-timestamp pull-right">02:34
                                                            PM</small>
                                                        <div class="notification-heading">Mr. John</div>
                                ...
                                <div class="recent-comment m-t-15">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src="<?= base_url('images/avatar/1.jpg') ?>"
                                                    alt="..."></a>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src="<?= base_url('images/avatar/2.jpg') ?>"
                                                    alt="..."></a>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src="<?= base_url('images/avatar/3.jpg') ?>"
                                                    alt="..."></a>
                                        </div>
                                        <div class="media-body">
